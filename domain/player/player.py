...
class Player(Character):
    ...
    def get_next_direction(self, enemies: List[Position], available_food: List[Position]) -> Direction:
        raise NotImplementedError()

    def move_to_next_position(self, enemies: List[Position], available_food: List[Position]) -> None:
