...
class PlayerSearchAlgorithm(Player):
    ...
    def get_next_direction(self, enemy_positions: List[Position], available_food: List[Position]) -> Direction:
    ...
    def move_to_next_position(self, enemy_positions: List[Position], available_food: List[Position]) -> None:
        next_position = self.get_next_position()
        self.set_position(next_position)
        self.direction = self.get_next_direction(enemy_positions, available_food)
